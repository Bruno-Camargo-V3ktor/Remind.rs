use crate::{CreateNoteService, ServiceBuilder};

use super::super::NoteRepositoryType;

pub struct CreateNoteBuilder {
    note_repo: Option<NoteRepositoryType>,
}

impl CreateNoteBuilder {
...
impl ServiceBuilder for CreateNoteBuilder {
    type S = CreateNoteService;
